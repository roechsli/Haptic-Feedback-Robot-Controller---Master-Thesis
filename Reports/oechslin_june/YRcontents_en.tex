...
\newcommand{\YRachievement}{
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.7\linewidth]{Figs/bode_sp_damp215}
		\caption{Bode plot of analytical transfer function for $b_{sp} = 215$Ns/m.}
		\label{fig:bode_sp_damp215}
	\end{figure}
	
	As it can be seen in figure \ref{fig:bode_sp_damp215} there is a constant gain of $1$ for lower frequencies and a slight resonance top becomes visible around $166$Hz. The phase shift is of around $140^\circ$ for the frequencies of interest. Due to the setup constraints, the analytical results of higher frequencies have not been considered.
