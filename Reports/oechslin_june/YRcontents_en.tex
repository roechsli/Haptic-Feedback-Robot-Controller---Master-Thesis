...
\newcommand{\YRachievement}{
	...
	Combining all these equations one can find the block diagram as depicted in figure \ref{}.
	%TODO make block diagram, put here and reference
	From this diagram one can obtain the transfer functions that relate the output $x$ and input $x_{ref}$ as defined in equation \ref{eq:tf_complete}.
	\begin{equation}
