...
\newcommand{\YRachievement}{
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.2\linewidth]{Figs/max_volt_applied_plot}
		\caption{Operational range of photoreceptor with springs at rest and in full compression.}
		\label{fig:max_volt_applied_plot}
	\end{figure}
	
	The values that have been found to be the two limit values are resumed in table \ref{label}.
	
	\begin{figure}[h!]
		\centering
		\begin{tabular}{|l|c|c|c|c|}
			\hline
			& Sensor reading at rest & Distance at rest & Sensor reading in compression & Distance in compression \\ \hline \hline
			Left side & 20 &  20 & [-]  \\ \hline
			Right side & $33:1$ & $112:1$ &  [-] \\ \hline
		\end{tabular}
