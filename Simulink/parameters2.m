...
% Mechanical
%assumed_max_comp = 3E-3 % [m] // is what is expected to be the biggest 
...
% or found in simulation

% Operator // can be very high to simulate a wall or moderate for the real
% operator evnironment
k_op = 200%200 % [N/m] (stiffness of operators hand)
b_op = 20%20 % [Ns/m] (damping of operators hand)
